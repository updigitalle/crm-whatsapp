...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este link não corresponde a um convite válido. Confira a URL ou peça para quem te convidou enviar um novo link.',
  },
  used: {
  ...
  expired: {
    ...
    body: 'Este convite expirou. Peça ao administrador da conta para enviar um novo — leva só alguns segundos para gerar.',
  },
  server_error: {
    title: 'Algo deu errado',
    body: 'Não conseguimos verificar este convite agora. Tente atualizar a página daqui a pouco.',
  },
};
