...
export function ProfileForm() {
    ...
    try {
      ...
      if (trimmedEmail.toLowerCase() !== profile.email.toLowerCase()) {
        ...
        if (emailError) {
          ...
          toast.error(`Falha ao alterar o email: ${emailError.message}`);
          setSaving(false);
      ...
      toast.success(
        emailSent
          ? 'Perfil salvo — verifique seu email para confirmar a alteração do endereço'
          : 'Perfil salvo',
      );
    } catch (err) {
  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Seu perfil"
        description="Como você aparece no aplicativo. Seu avatar e nome aparecem no cabeçalho, na barra lateral e em qualquer lugar onde sua equipe possa vê-los."
      />
