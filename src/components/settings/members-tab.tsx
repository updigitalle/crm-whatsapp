  ...
  return (
    <section className="animate-in fade-in-50 space-y-6 duration-200">
      <SettingsPanelHead
        ...
        description="Pessoas com acesso a esta conta. As funções controlam o que cada colega pode fazer."
        action={
              ...
              return (
                ...
                >
                  ...
                  <div className="hidden sm:block text-right text-xs text-muted-foreground">
                    Ingressou em {fmtDate(member.joined_at)}
                  </div>
        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-muted-foreground">
              A URL de convite em texto simples é exibida apenas uma vez
              na criação, por segurança — para compartilhar novamente,
        ...
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              da conta? A sessão dele será encerrada nesta conta e uma nova
              conta pessoal será criada no próximo login. O login dele não
              é excluído.
            </DialogDescription>
          </DialogHeader>
