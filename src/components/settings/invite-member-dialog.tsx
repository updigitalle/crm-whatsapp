        ...
        {result ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                cadastrar (ou fazer login) e entrar na conta como{' '}
                <span className="font-medium text-muted-foreground">{ROLE_META[result.role].label}</span>
                . O link é válido por{' '}
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Nunca armazenamos o texto simples — assim que você fechar
                esta janela, a URL desaparece. Para compartilhar de novo,
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Gere um link de convite de uso único. Compartilhe-o pelo
                WhatsApp, Slack ou qualquer canal que preferir — nenhum
                serviço de email é necessário.
              </DialogDescription>
            </DialogHeader>
