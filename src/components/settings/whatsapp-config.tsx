...
export function WhatsAppConfig() {
  ...
  async function handleReset() {
    if (!confirm('Isso vai apagar a configuração atual do WhatsApp para que você possa reinseri-la. Continuar?')) {
      return;
    }
      ...
      <div className="space-y-6">
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  . Digite (ou corrija) o PIN de verificação em duas
                  etapas abaixo e clique em Salvar configuração para
                  tentar novamente.
                </>
              ) : (
                <>
                  Este número foi salvo antes de existir o rastreamento
                  de registro, ou o registro foi ignorado. Digite o PIN
                  de verificação em duas etapas abaixo e clique em
                  Salvar configuração para inscrevê-lo.
                </>
              )}
            </AlertDescription>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Digite suas credenciais da API do WhatsApp Business da Meta.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                <strong className="text-muted-foreground">entrada</strong> de
                ...
                número — caso contrário, a Meta roteia os eventos de
                entrada para o último app que os reivindicou (o sintoma
                que afeta números secundários sob uma WABA
                compartilhada).{' '}
                <strong className="text-muted-foreground">Números de teste da Meta</strong> não
                têm PIN e já vêm pré-registrados — deixe em branco para
                eles. Deixar em branco também mantém um registro
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Use esta URL como retorno de chamada (callback) do webhook no Painel de Apps da Meta.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
