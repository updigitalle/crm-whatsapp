  ...
  out_of_office: {
    ...
    steps: [
      ...
      },
      {
        ...
        step_config: {
          text:
            "Obrigado pela sua mensagem! Nossa equipe está fora do horário de atendimento agora (9h–18h) e vai responder assim que possível amanhã.",
        },
        parent_index: 0,
        branch: 'yes',
      },
    ...
    steps: [
      {
        ...
        step_config: {
          text:
            "Ótimo — vamos falar sobre preços! Uma pergunta rápida: aproximadamente quantos usuários você está buscando?",
        },
      },
      {
        step_type: 'wait',
  ...
  follow_up_reminder: {
    ...
    steps: [
      ...
      },
      {
        ...
        step_config: {
          text:
            "Só para retomar o contato — ficou alguma outra dúvida? Estamos à disposição!",
        },
      },
    ],
  },
